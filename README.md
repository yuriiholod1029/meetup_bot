...
An application to manage the participants of a meetup
...
Add `cd meetup-bot; meetup-bot/bin/backup-to-email.sh target@email.address` to crontab. This assumes you have configured email access in `.env` properly.
